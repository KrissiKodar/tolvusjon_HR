...
#modelConfiguration = 'C:\models\yolov4_custom.cfg'
#modelWeights = 'C:\models\yolov4_custom_last.weights'

modelConfiguration = 'C:\models\yolov3-tiny_rps.cfg'
modelWeights = 'C:\models\yolov3-tiny_rps_best.weights'

#modelConfiguration = 'C:\models\yolov7-tiny_RPS_test.cfg'
#modelWeights = 'C:\models\yolov7-tiny_RPS_test_last.weights'
...
def findObjects(outputs, img):
    ...
    for i in indices:
        ...
        cv.putText(img, f'{classNames[classIds[i]].upper()} {int(confs[i] * 100)}%',
                   (x, y - 10), cv.FONT_HERSHEY_SIMPLEX, 1, (10, 0, 255), 2)
